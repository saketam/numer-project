...
var y, error, exact;
class CentralOH263 extends Component {
    constructor() {
        super();
        this.state = {
            fx: "",
                ...
                <div>
                    ...
                    >
                        ...
                        <Button id="submit_button" onClick={
                            () => this.forwardoh(parseFloat(this.state.x), parseFloat(this.state.h), parseInt(this.state.degree))
                        }>submit</Button>
