...
class MatrixIM24 extends Component {
    ...
    inverse(n) {
        ...
        try {
            ...
            //console.log(output)      
            for (let i = 0; i < n; i++) {
                output.push(<span>X<sub>{i + 1}</sub>=&nbsp;&nbsp;{math.multiply(A, B)[i]}</span>);
                output.push(<br />)
            }
            ...
            <div>
                ...
                >
                    ...
                    {this.state.showMatrixButton &&
                        <Button id="matrix_button" onClick={() => this.inverse(this.state.dimension)}>submit</Button>
                    }
