...
class FalsePo13 extends Component {
    constructor() {
        super()
        this.state = {
            fx: "",
            ...
            <div>
                ...
                >
                    <div style={left}>
                        ...
                        <Input name="xl"  placeholder="" />
                        <br /><br />

                        <span>X<sub>r</sub></span>
                        <Input name="xr"  placeholder="" />
                        <br /><br />
                    </div>

                    <Button onClick={() => this.falseposition(parseFloat(this.state.xl), parseFloat(this.state.xr))}>submit</Button>
